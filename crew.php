<htlm>
    ...
    <head>
        ...
        <script src="jsCrew.js" defer="true">
        </script>
    ...
    <body>
        <nav>
            ...
            <a class='choice' href="prenota.php"> Prenota</a>
            <a class='choice' href="menu.php"> Menù</a>
            <a class='choice' href="areap.php"> Area Personale</a>
            <a class='choice' href="mhw1.php"> Home</a>
            <a class='choice' href="contatti.php"> Contattaci</a>
